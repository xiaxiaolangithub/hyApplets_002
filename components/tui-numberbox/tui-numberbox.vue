<template>
	<view class="tui-numberbox">
		...
		<input type="number" v-model="inputValue" disabled class="tui-num-input" :style="{color:color,fontSize:size+'rpx',backgroundColor:backgroundColor,height:height+'rpx',minHeight:height+'rpx',width:width+'rpx'}" />
